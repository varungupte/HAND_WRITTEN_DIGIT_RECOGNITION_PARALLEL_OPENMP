...
#define num 10000	   // Number of Training Images to Read
#define test_num 1000  // Number of Testing Images to Read	
#define MINIBATCH 1000 // Must divide into SAMPLE_SIZE evenly
...
int main(int argc, char const *argv[])
{
	...
	vector<vector<double> > x(MINIBATCH,vector<double> (inputN,0)); //Input layer
	vector<vector<double> > hidden(MINIBATCH,vector<double> (hN,0));//hidden layer
	vector<vector<double> > out(MINIBATCH,vector<double> (outN,0)); //predicted output fom output layer
